...
@Wid(widfile = "EthereumQueryExistingContract.wid", name = "EthereumQueryExistingContract",
        ...
        mavenDepends = {
                @WidMavenDepends(group = "org.jbpm.contrib", artifact = "ethereum-workitem", version = "7.50.0-SNAPSHOT")
        },
        serviceInfo = @WidService(category = "Ethereum", description = "Integrate with the Ethereum Blockchain app platform",
